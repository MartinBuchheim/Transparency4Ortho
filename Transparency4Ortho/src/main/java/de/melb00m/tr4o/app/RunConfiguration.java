...
public class RunConfiguration {
  ...
  private final Path temporariesBasePath = Paths.get(System.getProperty("user.dir")).resolve("tmp");
  private final Path binariesPath = Paths.get(System.getProperty("user.dir")).resolve("bin");
